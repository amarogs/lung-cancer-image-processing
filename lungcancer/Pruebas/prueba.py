...
# verts, faces = funciones.make_mesh(funciones.obtener_array(img), -800)
# funciones.plotly_3d(verts, faces,)
#ws = sitk.MorphologicalWatershed(img_segmentada, markWatershedLine=True, level=28, fullyConnected=False)
# overlay = sitk.LabelToRGB(ws)